...
struct  DtwTree{
    ...
    void (*add_tree_part)(struct DtwTree *self, struct DtwTreePart *tree_part);
    void (*delete_tree)(struct DtwTree *self);
    void(*represent)(struct DtwTree *self);
};
void private_dtw_add_tree_part(struct DtwTree *self, struct DtwTreePart *tree_part);
...
struct  DtwTree * dtw_tree_constructor(){
    ...
    self->add_tree_part = private_dtw_add_tree_part;
